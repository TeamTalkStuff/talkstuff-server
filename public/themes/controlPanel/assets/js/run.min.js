...
var app = new Vue({
    ...
    methods: {
        ...
        printHtml: function printHtml(html) {
            ...
            var htmlDocument = "<!doctype html>" + "<html>" + "<head>" + "<link rel=\"stylesheet\" href=\"/css/print.css\" type=\"text/css\" media=\"print\"/>" + "</head>" + '<body onload="printAndRemove();">' + // Print only after document is loaded
            html + '</body>' + "</html>";
